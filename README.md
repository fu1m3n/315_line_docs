...
Каждый экран содержит названия подсекций станции и 2 кнопки для навигации между окнами системы. По клику мыши происходит переход на следующее/предыдущее окно. Проект находится в папке [SCADA](https://github.com/fu1m3n/315_line_docs/tree/main/SCADA).
...
### Введение
Код программы на языке Python находится [здесь](https://github.com/fu1m3n/315_line_docs/blob/main/main.py).
...
- [Automating_with_FST](https://github.com/fu1m3n/315_line_docs/blob/main/Docs/manualsFST/Automating_with_FST.pdf)
- [Festo Software Tool_1](https://github.com/fu1m3n/315_line_docs/blob/main/Docs/manualsFST/Festo%20Software%20Tool_1.pdf)
- [Festo Software Tool_2](https://github.com/fu1m3n/315_line_docs/blob/main/Docs/manualsFST/Festo%20Software%20Tool_2.pdf)
...
```
2. Установите зависимости из папки проекта
```
...
Альтернативный способ подключения SCADA-системы к установке - использование протокола OPC DA и стороннего сервера. Для этого можно запустить программы [OPC DA Server](https://github.com/fu1m3n/315_line_docs/blob/main/programs/OPC%20DA%20Server.exe) и [MatrikonExplorer](https://github.com/fu1m3n/315_line_docs/blob/main/programs/matrikonopcexplorer.exe) на операционной системе Windows.
...
![1](https://github.com/user-attachments/assets/aaee80d3-9079-4350-bf42-f8d8ae6fec13)

![2](https://github.com/user-attachments/assets/39be8129-9669-4a04-a2f5-dd8827a693c5)

Здесь необходимо указать адрес компьютера, который был установлен в настройках.
![3](https://github.com/user-attachments/assets/1a1462c0-b575-46aa-8456-49b0656bb4a9)

Далее для каждой установки необходимо создать Topic Definition.
![4](https://github.com/user-attachments/assets/11d82853-33a8-4423-be4f-3681ebade4b6)
...
![5](https://github.com/user-attachments/assets/f794719c-e74a-4493-993e-2bd0b043c230)

![6](https://github.com/user-attachments/assets/8f6288fb-089d-4860-9ee8-0de6330bbe17)
...
![7](https://github.com/user-attachments/assets/c848c160-11d2-47af-82f6-43be42007557)
...
3. Рассмотреть использование Kubernetes или аналогичной системы оркестрации контейнеров для обеспечения масштабируемости, надежности и удобства управления.
4. Создать Dockerfile, который будет содержать все необходимые инструкции для сборки образа.
